...
dual-grid corner-triangle geometry and builds the animated water strip. A paired
tangent-space normal map (`terrain_atlas_n.png`) is generated by `tools/gen_normal_atlas.py`
so the sun light shades the diamonds with relief.
